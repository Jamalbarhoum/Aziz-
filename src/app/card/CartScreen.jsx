...
function CartScreen() {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      <View style={{direction:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
      <Text style={styles.priceText}><Text style={{color:"#0129",fontWeight:"normal"}}>JD</Text> {item.price}</Text>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.containerViewCard}>
        ...
        {cartItems.length !== 0 && (
          <Button title="Edit Cart" onPress={handleOpenEditModal} />
        )}
      </View>
      ...
      {modalVisible && (
        <Modal transparent={true} visible={modalVisible} animationType="slide">
          ...
          <Icon  onPress={() => handleDecreaseQuantity(item.id)} name="minus" size={15} color="black" />
          ...
          <Icon   onPress={() => handleIncreaseQuantity(item.id)} name="plus" size={15} color="black" />
                      <Icon onPress={() => handleRemoveItem(item.id)}  name="trash" size={22} color="red" />
                    </View>
                  </View>
                </View>
              ))}
